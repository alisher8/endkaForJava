...
public interface UserRelationshipRepo extends JpaRepository<UserRelationship, UserRelationshipKey> {
    ...
    @Query(" SELECT new com.endterm.project.Pojos.UserFriendsDto (ur.id.userFirstId, ur.id.userSecondId, ur.myUser2.email, ur.myUser2.firstName, ur.myUser2.lastName) FROM UserRelationship ur " +
    ...
    @Query(" SELECT new com.endterm.project.Pojos.UserFriendsDto (ur.id.userFirstId, ur.id.userSecondId, ur.myUser1.email, ur.myUser1.firstName, ur.myUser1.lastName) FROM UserRelationship ur " +
